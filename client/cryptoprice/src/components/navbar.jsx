...
return(
    <>
   <header class="mb-2 px-8 shadow  font-mono">
  <div class="relative flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
    <a class="flex items-center text-xl font-black" href="/">
      ...
      ></span>
      <span className="text-black-600 text-md font-serif">OneBitcoin</span>
    </a>
    ...
    <nav aria-label="Header Navigation" class="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
      <ul class="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
        <li class=""><a class="text-gray-600 hover:text-blue-600" href="/trending">Top Trending</a></li>
        <li class=""><a class="text-gray-600 hover:text-blue-600" href="/exchanges">Exchanges</a></li>
